<template>
  <div ref="staffData">
    ...
    <div class="addstaffsection">
      <form id="addstaff" method="POST" @submit.prevent="addStaff">
        <label for="namestaff">Name :</label>
        <input type="text" name="namestaff" class="form-control" v-model="StaffName" />

        <label for="workstaff">Work :</label>
        <select name="workstaff" v-model="StaffWork" class="form-control">
        ...
        <button type="submit" class="btn btn-success" name="addstaffbutton">Add</button>
      </form>
    </div>
    <div class="staffbox">
