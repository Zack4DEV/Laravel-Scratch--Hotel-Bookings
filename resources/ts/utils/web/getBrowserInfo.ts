...
/**
   ...
   isMobile: boolean;
   /**
    * Whether to open in WeChat
    */
   isInWeChatApp: boolean;
   /**
    * Whether to open in WeChat mini program
    */
   isInMiniProgram: boolean;
   /**
    * Whether to open it in WeChat developer tools
    */  
...
/**
  * Get the unique tag of the device
  * @description The implementation principle comes from uni-app getsysteminfo. Clearing Storage will cause changes
  */
